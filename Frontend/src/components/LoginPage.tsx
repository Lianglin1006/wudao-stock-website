    ...
    <div className="bg-[#1c2534] min-h-screen w-full text-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col p-[40px]">
        ...
        <div className="mb-[24px]">
          <Breadcrumb>
            <BreadcrumbList className="text-[rgba(255,255,255,0.6)]">
              ...
              <BreadcrumbItem>
                <BreadcrumbPage className="text-white text-[14px]">登录</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          >
          <h1 className="text-[32px] text-center mb-[12px]">登录</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-[24px]">
            {/* Username */}
            <div>
              <label className="block text-[14px] mb-[8px]">用户名 / 邮箱</label>
              <input
                type="text"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-[8px] cursor-pointer">
                <input
                  ...
                  className="size-[18px] rounded-[3px] bg-[#1c2534] border-2 border-[rgba(245,245,245,0.6)] checked:bg-[#637ffc] checked:border-[#637ffc] cursor-pointer"
                />
                <span className="text-[14px] text-[rgba(255,255,255,0.8)]">记住我</span>
              </label>
              <motion.button
                type="button"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="text-[14px] text-[#637ffc] hover:text-[#7389fd]"
              >
                忘记密码？
              </motion.button>
            </div>
            ...
            <div className="text-center">
              <span className="text-[14px] text-[rgba(255,255,255,0.6)]">还没有账号？</span>
              <motion.button
                type="button"
